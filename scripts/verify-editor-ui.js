...
expect('page nav is edit-only', pageDots.includes("editorMode === 'edit'"))
expect('page nav has no dot scroll row', !pageDots.includes('dots-scroll') && !pageDots.includes('wx:for="{{bookPages}}"'))
expect('page nav contains add page action', pageDots.includes('addNewPage'))
expect('page nav contains fixed delete page action', pageDots.includes('deleteCurrentPage') && pageDots.includes('isCoverPage'))
